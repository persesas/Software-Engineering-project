...
class MediatorTest(unittest.TestCase):
    ...
    def test_create_event(self):
        ...
        event_id = m.create_client_req(cl_id, 'Super Party', 'description', '01-01-01', '02-02-02', 20, 100, 'deco',
                                       'filming',
                                       'poster', 'food', 'music', 'computer', 'other')
    ...
    """def test_update_task(self):
        ...
        task_data = c.get_task('id', task_id, all_data=False)[0]
        ...
        self.assertEqual('em987654', task_data['staff_id'])
